...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="land-hero">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_.9fr] gap-12 items-center">
          <div className="rise">
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-[1.12] mt-3 font-[family-name:var(--font-geist-mono)]">
              Financeiro e pessoas.
              <br />
              Uma plataforma <span style={{ color: "var(--gold)" }}>só para empresas.</span>
            </h1>
            <p className="mt-5 text-[#b9bedb] text-lg max-w-xl">
              CodeCraft Gestão une caixa, títulos, DRE, colaboradores e ponto eletrônico.
              Multi-tenant com RLS. Sem IA no painel — operação humana, clara e segura.
            </p>
          ...
          <div className="card p-6 bg-[#1e2547] border-[#2c3358] text-white">
            ...
            <div className="grid grid-cols-2 gap-3 mt-5">
              {[
                ...
                <div key={k} className="rounded-xl p-4" style={{ background: "#161b33" }}>
      ...
      <section id="modulos" className="py-20 px-8">
        <div className="max-w-6xl mx-auto">
          <p className="kicker">Módulos</p>
          <h2 className="text-3xl font-extrabold mt-2 font-[family-name:var(--font-geist-mono)]">Operação unificada.</h2>
      ...
      <section id="assinatura" className="py-20 px-8 bg-bg-2">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-3xl font-extrabold mt-2 font-[family-name:var(--font-geist-mono)]">R$ 280 a R$ 500 por mês.</h2>
          <p className="text-muted mt-2">Cartão com renovação automática. Cancelamento autônomo no painel.</p>
