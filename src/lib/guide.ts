...
export const GUIDE: GuideItem[] = [
  ...
  { href: "/app/ferramentas", title: "Ferramentas", does: "Reserva, meses passados, 50-30-20, corte, dívida, moradia. Empresa: giro e preço.", tip: "No grátis você vê alerta e reserva. O resto entra no Pessoal (R$ 19)." },
  ...
  { href: "/app/planos", title: "Planos", does: "Pessoal R$ 19, Empresa R$ 49, Completo R$ 59. Completo sai mais barato que os dois.", tip: "Pague só no PIX 31999758385." },
